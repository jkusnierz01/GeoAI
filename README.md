...
2. Get data
    * GEOJSONS - Prepare data:
        1. `python3 data_scripts/download_data.py`
        2. `python3 data_scripts/hexes_to_graph.py -i amenities_hexagons_res7.geojson -o graph_res7.pt`
        3. `python3 data_scripts/load_graph.py -i graph_res7.pt`
...
4. Embeddings:
    * T-SNE: `python3 visualize/show_embeddings.py --dataset dataset --model_path checkpoint.pt --samples_per_graph 100`
